...
class ComprehensiveFinancialReportAPI(APIView):
    ...
    # --- HTTP HANDLER (sends data to frontend) ---
    ...
    # --- ALL HELPER FUNCTIONS (alphabetical order kept, but all below the handler) ---
    ...
    def generate_cash_flow_statement(self, start_date, end_date):
        ...
        changes_in_working_capital = Decimal('0')
...
class FinancialProjectionsAPI(APIView):
    ...
    def generate_projections(self, years, growth_rate):
        ...
        for year in range(1, years + 1):
            ...
            projected_profit = base_profit * Decimal((1 + growth_rate * 0.8) ** year)
            projected_assets = base_assets * Decimal((1 + growth_rate * 0.5) ** year)
